...
public class ARFeatheredPlaneMeshVisualizer : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        m_FeatheredPlaneMaterial = GetComponent<MeshRenderer>().material;//平面标记图标
        m_Plane = GetComponent<ARPlane>();
    }

    void OnEnable()
    {
        m_Plane.boundaryChanged += ARPlane_boundaryUpdated;//添加事件
    }
    ...
    void GenerateBoundaryUVs(Mesh mesh)//*边界平滑渐隐（fade out）
    {
        ...
        Vector3 centerInPlaneSpace = s_Vertices[s_Vertices.Count - 1];//获取最近一组顶点
