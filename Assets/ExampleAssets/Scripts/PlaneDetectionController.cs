...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class PlaneDetectionController : MonoBehaviour
    {
        ...
        void Start()
        {//每次点击切换检测平面可见性
            m_TogglePlaneDetectionButton.onClick.AddListener(() =>
            {
        ...
        [SerializeField]
        Button m_TogglePlaneDetectionButton;
        public Button TogglePlaneDetectionButton
        {
            set => m_TogglePlaneDetectionButton = value;
            get => m_TogglePlaneDetectionButton;
        }
